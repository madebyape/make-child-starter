...
<header class="ch-header">
	<!-- logo here -->
	<a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home"><img src="<?php bloginfo('stylesheet_directory')?>/img/jhc-systems-logo.svg" class="logo_image" width="201"/></a>
	<nav id="cd-top-nav"><!-- your primary navigation here -->
		<?php
			wp_nav_menu( array(
				'theme_location' => 'primary'
			) );
